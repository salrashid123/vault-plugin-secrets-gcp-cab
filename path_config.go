...
func (b *backend) pathConfig() *framework.Path {
	return &framework.Path{
		...
		HelpSynopsis: "Configure the GCP Private CA secrets engine",
		HelpDescription: "Configure the GCP Private CA secrets engine by specifying the CA name, " +
...
// pathConfigRead corresponds to READ config and is used to
...
// pathConfigWrite corresponds to both CREATE and UPDATE config and is
...
// pathConfigDelete corresponds to DELETE config and is used to delete
